...
public class ProductServiceImpl implements IProductService {
    ...
    public void save(ProductVo productVo) {
        ...
        if(record > 0){
            ...
            //保存商品属性
            for(ProductPropertyValue ppv:productVo.getProductPropertyValueList()){
                ppv.setProductId(productVo.getProduct().getId());
                productPropertyValueMapper.insert(ppv);
            }
    ...
    public Integer queryCountByCatalogId(Long catalogId) {
        return productMapper.queryCountByCatalogId(catalogId);
    }
}
